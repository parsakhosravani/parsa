    ...
    <Card>
      <div className="relative w-full h-full p-4 md:p-8">
        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          <h2
            className={`font-bold text-zinc-100 group-hover:text-white font-display ${
    ...
    const fetchProjects = async () => {
      try {
        ...
        const filteredProjects = repos
          .filter(
            (repo) =>
              !repo.name.includes(".github") && !repo.name.includes("config"),
          )
          .map((repo) => ({
            id: repo.id,
            name: repo.name,
      ...
      <div className="bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 relative pb-16">
        ...
        <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
          <div className="max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="mt-4 text-red-400">Error loading projects: {error}</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 relative pb-16">
      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-4 text-zinc-400">
            A collection of my open source projects and experiments. All sourced
            directly from my GitHub repositories.
          </p>
        </div>
        <div className="w-full h-px bg-zinc-800" />
