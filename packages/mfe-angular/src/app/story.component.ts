...
/**
 * Proper Angular standalone component — replaces the JIT bootstrap
 * that used to live inside a React useEffect.
 * Selector must match the host element created in bootstrap.ts.
 */
@Component({
  selector: "app-story",
  standalone: true,
